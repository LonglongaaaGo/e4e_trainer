...
from datasets.images_dataset import ImageFolder_restore
...
class Coach:
    ...
    def train(self):
        ...
        while self.global_step < self.opts.max_steps:
            for batch_idx, batch in enumerate(self.train_dataloader):
                ...
                #
                real_img = real_img.to(self.device).to(torch.float32) / 127.5 - 1
                low_img = low_img.to(self.device).to(torch.float32) * 2.0 - 1
    ...
    def configure_datasets(self):
        ...
        train_dataset = ImageFolder_restore(self.opts.img_path, transform=transforms_dict['transform_test'],im_size=(self.opts.size,self.opts.size))
        test_dataset = ImageFolder_restore(self.opts.img_test_path, transform=transforms_dict['transform_test'],im_size=(self.opts.size,self.opts.size))
